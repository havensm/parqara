...
export function SiteFooter() {
  ...
  return (
    <footer className="px-4 pb-3 sm:px-8 sm:pb-4 lg:px-10">
      <div className="mx-auto max-w-[94rem]">
        <div className="surface-shell relative overflow-hidden rounded-[28px] px-5 py-5 sm:px-6 sm:py-6">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_16%,rgba(99,167,255,0.12),transparent_22%),radial-gradient(circle_at_86%_22%,rgba(28,198,170,0.1),transparent_22%)]" />
